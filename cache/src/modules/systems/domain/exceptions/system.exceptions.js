...
class SystemNameRequiredException extends domain_exceptions_1.DomainException {
    constructor() {
        ...
        this.name = domainException_enum_1.DomainExceptionCode.SYSTEM_NAME_REQUIRED;
    }
    static getMessage() {
...
class SystemDescriptionRequiredException extends domain_exceptions_1.DomainException {
    constructor() {
        ...
        this.name = domainException_enum_1.DomainExceptionCode.SYSTEM_DESCRIPTION_REQUIRED;
    }
    static getMessage() {
...
class SystemUrlRequiredException extends domain_exceptions_1.DomainException {
    constructor() {
        ...
        this.name = domainException_enum_1.DomainExceptionCode.SYSTEM_URL_REQUIRED;
    }
    static getMessage() {
...
class SystemUrlInvalidException extends domain_exceptions_1.DomainException {
    constructor() {
        ...
        this.name = domainException_enum_1.DomainExceptionCode.SYSTEM_URL_INVALID;
    }
    static getMessage() {
...
class SystemClassCssRequiredException extends domain_exceptions_1.DomainException {
    constructor() {
        ...
        this.name = domainException_enum_1.DomainExceptionCode.SYSTEM_CLASS_CSS_REQUIRED;
    }
    static getMessage() {
...
class SystemNotFoundException extends domain_exceptions_1.DomainException {
    constructor() {
        ...
        this.name = domainException_enum_1.DomainExceptionCode.SYSTEM_NOT_FOUND;
    }
    static getMessage() {
